...
const app = getApp(); // 用来获取到小程序 App 实例
Page({
  data: {
    city: '正在定位...',
    params: { //url请求参数对象
  ...
  initPage() {
    ...
    wx.request({
      // url: 'https://m.maoyan.com/ajax/filterCinemas', CINEMAE_REPONSE_TIME
      url: 'http://localhost:8080/cinemainterface/filtercinemas',
      success(res) {
        _this.setData({
    ...
    return new Promise((resolve, reject) => {
      wx.request({
       //  url: 'https://m.maoyan.com/ajax/cinemaList',
        url: 'http://localhost:8080/cinemainterface/cinemalist',
        data: params,
        success(res) {

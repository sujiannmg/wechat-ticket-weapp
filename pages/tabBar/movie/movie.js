...
Page({
  ...
  firstLoad() {
    ...
    wx.request({
      ...
      url: 'http://localhost:8080/movieinterface/movieoninfolist',
      success(res) {
  ...
  selectItem(e) {
    ...
    if (item === 1 && !this.data.mostExpectedList.length) {
      ...
      wx.request({
        ...
        url: 'http://localhost:8080/movieinterface/mostexpected',
        success(res) {
          wx.hideLoading()
          _this.setData({
      ...
      wx.request({
        ...
        url: 'http://localhost:8080/movieinterface/cominglist',
        success(res) {
          wx.hideLoading()
          _this.setData({
  ...
  ReachBottom(list, ids, complete, item) {
    ...
    const url = `http://localhost:8080/movieinterface/morecominglist/${query}`
    wx.request({
      url,
      success(res) {
  ...
  lower() {
    ...
    wx.request({
      ...
      url: `http://localhost:8080/movieinterface/moremostexpected/${length}`,
      success(res) {
        _this.setData({
